...
export function EmailPreview({ subject, previewText, bodyHtml }: EmailPreviewProps) {
    ...
    return (
        <div className="flex flex-col h-full bg-slate-100 dark:bg-slate-900 rounded-lg overflow-hidden border border-border/40">
            <div className="bg-background border-b border-border/40 p-2 flex items-center justify-between">
            ...
            <div className="flex-1 overflow-y-auto p-4 flex justify-center">
                <div className="w-full max-w-[600px] bg-white text-slate-900 rounded shadow-sm flex flex-col min-h-[400px]">
                    ...
                    <div className="border-b border-gray-100 p-4 space-y-1">
                    ...
                    {/* Footer Simulation */}
                    <div className="mt-auto border-t border-gray-100 p-4 bg-slate-50 text-xs text-center text-slate-400">
