...
import { ManualInviteForm } from "./_components/ManualInviteForm";

interface InvitesPageClientProps {
  institutions: { institution_id: string; legal_name: string; trading_name: string | null }[];
}

export default function InvitesPageClient({ institutions }: InvitesPageClientProps) {
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        <TabsContent value="manual" className="space-y-4">
          <div className="max-w-2xl mx-auto">
            <ManualInviteForm institutions={institutions} />
          </div>
        </TabsContent>
