  ...
  try {
      ...
      return NextResponse.json(
        {
          ...
          enrolments: enrolments.map((enrolment) => ({
            ...
            learner_email: enrolment.learner.user?.email ?? null,
            qualification_id: enrolment.qualification_id,
            qualification_name: enrolment.qualification?.name ?? null,
            qualification_code: enrolment.qualification?.code ?? null,
            ...
            end_date: enrolment.expected_completion_date?.toISOString() || null,
    ...
    for (const enrolment of enrolments) {
      const row = [
        ...
        enrolment.expected_completion_date?.toISOString().split("T")[0] || "",
