...
interface InstitutionOnboardingProgressBarProps {
  currentStep: number;
  totalSteps: number;
}
...
export function InstitutionOnboardingProgressBar({
  currentStep,
  totalSteps,
}: InstitutionOnboardingProgressBarProps) {
